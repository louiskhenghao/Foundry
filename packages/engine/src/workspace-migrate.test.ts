...
const legacyGoal = (id: string, state: Goal['state']): Goal => {
  ...
  return {
    id, title: '把按钮改成蓝色，其它不动', prompt: 'p', workspaceDir: null, repoPath: repo, baseBranch: 'main', branch: `goal/${id}`,
