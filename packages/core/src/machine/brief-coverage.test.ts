...
const task = (key: string, areaKey: string | null, dependsOnKeys: string[] = []) => ({ key, title: key, spec: '', kind: 'feature' as const, scope: null, scenario: 'general' as const, areaKey, tdd: 'inherit' as const, dependsOnKeys, parallelizable: true, relevantFiles: [], milestone: null });
