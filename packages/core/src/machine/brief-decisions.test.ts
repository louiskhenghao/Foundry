...
const task = (key: string, spec = 's', deps: string[] = []) => ({ key, title: key, spec, kind: 'feature' as const, scope: null, scenario: 'general' as const, areaKey: null, dependsOnKeys: deps, parallelizable: true, relevantFiles: [] });
